                ...
                <div class="pure-control-group">
                    <div class="pure-g">
                        <div class="pure-u-2-3">
                            ...
                            <label>Phone</label>
                            <input type="text" class="pure-u-4-5" name="phone" placeholder="(032)4323212">
                        ...
                        <div class="pure-u-1-3">
                            ...
                            <label>Email</label>
                            <input type="email" class="pure-u-1" name="email" placeholder="sj321@gm.com">
                        </div>
                    </div>
                </div>  
                <label>Address</label>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form action="demo_form.asp">
                <!-- HIDDEN id here -->
                  <input type="image" src="images/edit.png" alt="Submit" class="icon">
                  <input type="image" src="images/delete.png" alt="Submit" class="icon">
                 </form>
            </td>
        </tr>
        <tr>
